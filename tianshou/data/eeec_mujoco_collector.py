...
class EEEC_MuJoCo_Collector(object):
    ...
    def collect(
        ...
        while True:
            ...
            if random:
                ...
                ############ get features ###############
                feature = result.get("feature", Batch())
            ...
            ############################## here to do the episodic control ############################
            if random:
                pass
            else:
                feature = feature[0]
                feature = feature.detach().cpu().numpy() 
                self.ep_reward.append(rew)
                self.feature_list.append(feature)
                if done:
                    self.memory.append(self.feature_list, self.ep_reward)
            ...
            if done and not random:
                if self.collect_step < 950000 and len(intrinsic_rewards) == ep_len[0]:
                    self.buffer.rew[ep_idx[0]: ep_idx[0] + ep_len[0]] += intrinsic_rewards
                else:
                    pass
